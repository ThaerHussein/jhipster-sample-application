...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fIrstApplicationApp.department.delete.question">
        <Translate contentKey="fIrstApplicationApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
