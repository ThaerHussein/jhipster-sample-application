...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_EMPLOYEES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMPLOYEE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMPLOYEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EMPLOYEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMPLOYEE actions', async () => {
      const arg = 42666;
