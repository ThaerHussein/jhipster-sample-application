  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fIrstApplicationApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="fIrstApplicationApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fIrstApplicationApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('fIrstApplicationApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('fIrstApplicationApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('fIrstApplicationApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('fIrstApplicationApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('fIrstApplicationApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('fIrstApplicationApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('fIrstApplicationApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('fIrstApplicationApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
