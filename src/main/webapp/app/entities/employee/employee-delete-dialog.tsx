...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fIrstApplicationApp.employee.delete.question">
        <Translate contentKey="fIrstApplicationApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
