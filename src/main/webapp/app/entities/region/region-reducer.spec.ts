...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_REGIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REGION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REGION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REGION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REGION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REGION actions', async () => {
      const arg = 42666;
