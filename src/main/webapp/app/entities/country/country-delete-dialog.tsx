...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fIrstApplicationApp.country.delete.question">
        <Translate contentKey="fIrstApplicationApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
