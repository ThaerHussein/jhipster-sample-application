    ...
    <Row>
      <Col md="8">
        <h2 data-cy="countryDetailsHeading">
          <Translate contentKey="fIrstApplicationApp.country.detail.title">Country</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="fIrstApplicationApp.country.region">Region</Translate>
          </dt>
