...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUNTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COUNTRIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COUNTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COUNTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COUNTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COUNTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COUNTRY actions', async () => {
      const arg = 42666;
