...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_JOBS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JOB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JOB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JOB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JOB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JOB actions', async () => {
      const arg = 42666;
