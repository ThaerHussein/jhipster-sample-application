...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fIrstApplicationApp.location.delete.question">
        <Translate contentKey="fIrstApplicationApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
