...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_JOBHISTORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JOBHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JOBHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JOBHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JOBHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JOBHISTORY actions', async () => {
      const arg = 42666;
