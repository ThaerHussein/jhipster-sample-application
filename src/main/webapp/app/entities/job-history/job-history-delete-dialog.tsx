...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fIrstApplicationApp.jobHistory.delete.question">
        <Translate contentKey="fIrstApplicationApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
